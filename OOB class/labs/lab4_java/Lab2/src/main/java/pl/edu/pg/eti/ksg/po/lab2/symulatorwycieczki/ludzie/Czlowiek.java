...
public abstract class Czlowiek implements Uczestnik {
    ...
    protected void aktualizujOdpoczynek(double czas) {
        double Odpoczynek = czas/czasPelnegoZmeczenia;
        poziomZmeczenia = Math.min(poziomZmeczenia - Odpoczynek, 1.0);
        if(poziomZmeczenia<0) poziomZmeczenia=0;
        System.out.println("Poziom zmęczenia u "+imie+" "+nazwisko+" zmalał o "+Odpoczynek +" i wynosi "+ poziomZmeczenia+".");
